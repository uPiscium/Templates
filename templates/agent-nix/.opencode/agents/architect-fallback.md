...
Analyze architecture with the same read-only authority as `architect`. This variant is only for classified usage-limit fallback. This is a non-interactive Depth-2 leaf.
