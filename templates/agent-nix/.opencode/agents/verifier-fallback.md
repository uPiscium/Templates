...
Run the same verification entry points and reporting contract as `verifier`. This variant is only for classified usage-limit fallback. This is a non-interactive Depth-2 leaf.
...
Do not edit, delegate, publish, or repair failures.
