...
- Unresolved leaf requests must not be inferred as approval. If the issue is consequential or ambiguous, Task Orchestrator must return BLOCKED and escalate to Depth 0 (`build`) for explicit user-facing decision.
