...
Review security with the same authority and evidence contract as `security-reviewer`. This variant is only for classified usage-limit fallback. This is a non-interactive Depth-2 leaf.
